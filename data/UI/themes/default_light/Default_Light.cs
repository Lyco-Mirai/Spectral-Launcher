...
{
    public class Default_Light: Theme_Base
    {
        public override string ThemeName() => "Default - Light";
        public override string ThemeType() => "Light";
        ...
        public override string ThemeFolder() => "default_light";
